...
# ✅ تعديل 1: خفض Dollar Volume من 3M إلى 1.5M عشان يشمل الأسهم الصغيرة في القائمة
...
# ✅ تعديل 2: رفع حد الصعود اليومي من 5% إلى 8% لحل التعارض مع شرط الاختراق
...
def evaluate_signal(df: pd.DataFrame) -> tuple[dict | None, str | None]:
    ...
    # --- 6) صعود اليوم لا يتجاوز 8% (✅ تعديل: رُفع من 5% لحل التعارض مع الاختراق) ---
